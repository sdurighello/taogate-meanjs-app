...
// EVALUATION-DASHBOARDS: Financial

angular.module('evaluation-dashboards').controller('DashboardFinancialController', ['$scope', '$stateParams', '$location', 'Authentication',
	'EvaluationDashboards','CategoryGroups', '_','$q',
	function($scope, $stateParams, $location, Authentication, EvaluationDashboards, CategoryGroups, _, $q) {
		...
		$scope.init = function(){
            ...
            EvaluationDashboards.projectCategorization(function(res){
