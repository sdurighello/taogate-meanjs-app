...
exports.getRiskCategories = function(req){
    return [
        {
            _id: r1,
            name: 'Delivery',
...
exports.getRiskImpacts = function(req){
    return [
        {
            _id: incidental,
            name: 'Incidental',
...
exports.getRiskProbabilities = function(req){
    return [
        {
            _id: rare,
            name: 'Rare',
...
exports.getRiskSeverities = function(req){
    return [
        {
            _id: high,
            name: 'High',
...
exports.getRiskSeverityAssignments = function(req){
    return [
        {
            impact: incidental,
