...
exports.seedRisks = function(req, callback){
...
// Severities
    ...
    async.series([
        function(callback) {
            var schema = mongoose.mtModel(req.user.tenantId + '.' + 'RiskCategory');
            var seedArray =  [
                {
                    _id: r1,
                    name: 'Delivery',
        ...
        function(callback) {
            var schema = mongoose.mtModel(req.user.tenantId + '.' + 'Risk');
            var seedArray =  [
                {
                    _id: r11,
        ...
        function(callback) {
            var schema = mongoose.mtModel(req.user.tenantId + '.' + 'RiskImpact');
            var seedArray =  [
                {
                    _id: incidental,
                    name: 'Incidental',
        ...
        function(callback) {
            var schema = mongoose.mtModel(req.user.tenantId + '.' + 'RiskProbability');
            var seedArray =  [
                {
                    _id: rare,
                    name: 'Rare',
        ...
        function(callback) {
            var schema = mongoose.mtModel(req.user.tenantId + '.' + 'RiskSeverity');
            var seedArray =  [
                {
                    _id: high,
                    name: 'High',
        ...
        function(callback) {
            var schema = mongoose.mtModel(req.user.tenantId + '.' + 'RiskSeverityAssignment');
            var seedArray =  [
                {
                    impact: incidental,
