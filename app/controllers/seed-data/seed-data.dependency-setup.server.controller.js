...
exports.seedDependencies = function(req, callback){
    ...
    async.series([
        function(callback) {
            var schema = mongoose.mtModel(req.user.tenantId + '.' + 'DependencyType');
            var seedArray =  [
                {
                    _id: inputForReview,
        ...
        function(callback) {
            var schema = mongoose.mtModel(req.user.tenantId + '.' + 'DependencyImpact');
            var seedArray =  [
                {
                    _id: veryHigh,
                    name: 'Very high',
        ...
        function(callback) {
            var schema = mongoose.mtModel(req.user.tenantId + '.' + 'DependencyState');
            var seedArray =  [
                {
                    _id: toBeDiscussed,
