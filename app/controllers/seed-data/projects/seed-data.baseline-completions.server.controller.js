...
exports.seedBaselineCompletions = function(user, callback){
    ...
    async.series([
        ...
        function(callback) {
            ...
            createObjects(BaselineCompletion, 'BaselineCompletion', seedArray, callback);
        }
    ], function (err, result) {
        if( err ) {
            console.log(err);
