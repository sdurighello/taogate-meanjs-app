...
exports.seedEstimateDurations = function(user, callback){
    ...
    var seedArray =  [
        ...
        },
        {
            ...
            currentRecord: {
                gateDate: new Date('2016-02-30T23:00:00Z'),
                completed : true,
                currentGate : false,
                sourceStatusUpdate: statusP1w11,
                sourceGateReview: null,
        ...
        },
        {
            ...
            currentRecord: {
                gateDate: new Date('2016-04-30T23:00:00Z'),
                completed : true,
                currentGate : false,
                sourceStatusUpdate: statusP1w11,
                sourceGateReview: null,
        ...
        },
        {
            ...
            currentRecord: {
                gateDate: new Date('2016-07-30T23:00:00Z'),
                completed : true,
                currentGate : false,
                sourceStatusUpdate: statusP1w11,
                sourceGateReview: null,
        ...
        },
        {
            ...
            currentRecord: {
                gateDate: new Date('2016-11-30T23:00:00Z'),
                completed : true,
                currentGate : false,
                sourceStatusUpdate: statusP1w11,
                sourceGateReview: null,
        ...
        },
        {
            ...
            currentRecord: {
                gateDate: new Date('2016-12-30T23:00:00Z'),
                completed : true,
                currentGate : false,
                sourceStatusUpdate: statusP1w11,
                sourceGateReview: null,
    ...
    createObjects(EstimateDuration, 'EstimateDuration', seedArray, callback);
};
