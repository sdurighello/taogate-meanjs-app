...
exports.seedProjectStatusUpdates = function(user, callback){
    ...
    async.series([
        ...
        function(callback) {
            var seedArray =  [
                {
                    ...
                    // Areas
                    statusAreaUpdates : [
                        {projectAreaReview : p1gw11Area1, newStatus : indicator3, comment : 'All delivered as expected'},
                        {projectAreaReview : p1gw11Area2, newStatus : indicator3, comment : 'All delivered as expected'},
                        {projectAreaReview : p1gw11Area3, newStatus : indicator3, comment : 'All delivered as expected'}
                    ],

                    // Outcomes
                    outcomeStatusUpdates : [
                        {outcomeReview : p1gw11Out1, newStatus : indicator3, comment : 'All delivered as expected'},
                        {outcomeReview : p1gw11Out2, newStatus : indicator3, comment : 'All delivered as expected'},
                        {outcomeReview : p1gw11Out3, newStatus : indicator3, comment : 'All delivered as expected'},
                        {outcomeReview : p1gw11Out4, newStatus : indicator3, comment : 'All delivered as expected'}
                    ],
                ...
                },
                {
                    ...
                    project: project1,
                    gate: w12,
                    title:'Status update Initiation',
                    description:'Periodic update',
                    ...
                    approval : {
                        ...
                        history : [
                            {approvalState: 'draft', created: new Date('2016-02-30T23:00:00Z'), user: user._id},
                            {approvalState: 'submitted', created: new Date('2016-02-30T23:00:00Z'), user: user._id}
                        ]
                    },
                    ...
                    // Areas
                    statusAreaUpdates : [
                        {projectAreaReview : p1gw12Area1, newStatus : indicator3, comment : 'All delivered as expected'},
                        {projectAreaReview : p1gw12Area2, newStatus : indicator3, comment : 'All delivered as expected'},
                        {projectAreaReview : p1gw12Area3, newStatus : indicator3, comment : 'All delivered as expected'}
                    ],

                    // Outcomes
                    outcomeStatusUpdates : [
                        {outcomeReview : p1gw12Out1, newStatus : indicator3, comment : 'All delivered as expected'},
                        {outcomeReview : p1gw12Out2, newStatus : indicator3, comment : 'All delivered as expected'},
                        {outcomeReview : p1gw12Out3, newStatus : indicator3, comment : 'All delivered as expected'}
                    ],
                ...
                },
                {
                    ...
                    // Areas
                    statusAreaUpdates : [
                        {projectAreaReview : p1gw13Area1, newStatus : indicator3, comment : 'All delivered as expected'},
                        {projectAreaReview : p1gw13Area2, newStatus : indicator3, comment : 'All delivered as expected'},
                        {projectAreaReview : p1gw13Area3, newStatus : indicator3, comment : 'All delivered as expected'}
                    ],

                    // Outcomes
                    outcomeStatusUpdates : [
                        {outcomeReview : p1gw13Out1, newStatus : indicator3, comment : 'All delivered as expected'},
                        {outcomeReview : p1gw13Out2, newStatus : indicator3, comment : 'All delivered as expected'},
                        {outcomeReview : p1gw13Out3, newStatus : indicator3, comment : 'All delivered as expected'},
                        {outcomeReview : p1gw13Out4, newStatus : indicator3, comment : 'All delivered as expected'},
                        {outcomeReview : p1gw13Out5, newStatus : indicator3, comment : 'All delivered as expected'}
                    ],
                ...
                },
                {
                    ...
                    // Areas
                    statusAreaUpdates : [
                        {projectAreaReview : p1gw14Area1, newStatus : indicator3, comment : 'All delivered as expected'},
                        {projectAreaReview : p1gw14Area2, newStatus : indicator3, comment : 'All delivered as expected'},
                        {projectAreaReview : p1gw14Area3, newStatus : indicator3, comment : 'All delivered as expected'}
                    ],

                    // Outcomes
                    outcomeStatusUpdates : [
                        {outcomeReview : p1gw14Out1, newStatus : indicator3, comment : 'All delivered as expected'},
                        {outcomeReview : p1gw14Out2, newStatus : indicator3, comment : 'All delivered as expected'},
                        {outcomeReview : p1gw14Out3, newStatus : indicator3, comment : 'All delivered as expected'},
                        {outcomeReview : p1gw14Out4, newStatus : indicator3, comment : 'All delivered as expected'}
                    ],
                ...
                },
                {
                    ...
                    // Areas
                    statusAreaUpdates : [
                        {projectAreaReview : p1gw15Area1, newStatus : indicator3, comment : 'All delivered as expected'},
                        {projectAreaReview : p1gw15Area2, newStatus : indicator3, comment : 'All delivered as expected'},
                        {projectAreaReview : p1gw15Area3, newStatus : indicator3, comment : 'All delivered as expected'}
                    ],

                    // Outcomes
                    outcomeStatusUpdates : [
                        {outcomeReview : p1gw15Out1, newStatus : indicator3, comment : 'All delivered as expected'},
                        {outcomeReview : p1gw15Out2, newStatus : indicator3, comment : 'All delivered as expected'},
                        {outcomeReview : p1gw15Out3, newStatus : indicator3, comment : 'All delivered as expected'},
                        {outcomeReview : p1gw15Out4, newStatus : indicator3, comment : 'All delivered as expected'}
                    ],
                ...
                },
                {
                    ...
                    gateStatusUpdate : {
                        gateStatusAssignment: p1gw16Status,
                        overallUpdate : {
                            status : indicator3,
                            comment : 'All delivered as expected'
                        },
                    ...
                    // Areas
                    statusAreaUpdates : [
                        {projectAreaReview : p1gw16Area1, newStatus : indicator3, comment : 'All delivered as expected'},
                        {projectAreaReview : p1gw16Area2, newStatus : indicator3, comment : 'All delivered as expected'},
                        {projectAreaReview : p1gw16Area3, newStatus : indicator3, comment : 'All delivered as expected'}
                    ],

                    // Outcomes
                    outcomeStatusUpdates : [
                        {outcomeReview : p1gw16Out1, newStatus : indicator3, comment : 'All delivered as expected'},
                        {outcomeReview : p1gw16Out2, newStatus : indicator3, comment : 'All delivered as expected'},
                        {outcomeReview : p1gw16Out3, newStatus : indicator3, comment : 'All delivered as expected'},
                        {outcomeReview : p1gw16Out4, newStatus : indicator3, comment : 'All delivered as expected'}
                    ],
            ...
            createObjects(ProjectStatusUpdate, 'ProjectStatusUpdate', seedArray, callback);
        }
    ], function (err, result) {
        if( err ) {
            console.log(err);
