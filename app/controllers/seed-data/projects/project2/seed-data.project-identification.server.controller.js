...
var _ = require('lodash'),
    ...
    projectsCreateController = require('../../../projects/projects.create.server.controller.js'),
    async = require('async'),
    User = mongoose.model('User');


var createObject = function(schema, stringMsg, item, callback){
    schema.findById(item._id).exec(function(err, itemReturned){
        if(!itemReturned){
            ...
            callback(null, stringMsg + 'already existing');
        }
    });
};
...
// Engagement approach
    ...
    var item = {
        ...
        categorization: [
            ...
            },
            {
                group: cat4,
                categories : [
                    {category: cat41, categoryValue: cat411},
                    {category: cat42, categoryValue: cat421},
                    {category: cat43, categoryValue: cat431}
                ]
            }
        ],
        prioritization: [
    ...
    createObject(Project, 'Project', item, callback);
