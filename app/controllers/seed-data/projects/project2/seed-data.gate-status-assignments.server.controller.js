...
exports.seedGateStatusAssignments = function(user, callback){
    ...
    createObjects(GateStatusAssignment, 'GateStatusAssignment', seedArray, callback);
};
