...
exports.seedGateReviews = function(user, callback){
    ...
    var seedArray =  [
        ...
        },
        {
            ...
            budget: 10000,
            outcomeReviews: [
                {outcomeReview: p1gw12Out1, newScore: goScore3, reviewComment: 'Outcome achieved as expected'},
                {outcomeReview: p1gw12Out2, newScore: goScore3, reviewComment: 'Outcome achieved as expected'},
                {outcomeReview: p1gw12Out3, newScore: goScore3, reviewComment: 'Outcome achieved as expected'}
            ],
        ...
        },
        {
            ...
            budget: 20000,
            outcomeReviews: [
                {outcomeReview: p1gw13Out1, newScore: goScore3, reviewComment: 'Outcome achieved as expected'},
                {outcomeReview: p1gw13Out2, newScore: goScore3, reviewComment: 'Outcome achieved as expected'},
                {outcomeReview: p1gw13Out3, newScore: goScore3, reviewComment: 'Outcome achieved as expected'},
                {outcomeReview: p1gw13Out4, newScore: goScore3, reviewComment: 'Outcome achieved as expected'}
            ],
            ...
            actualDurationReviews: [
                {actualDuration: actDur1Sw13Tw13, newDate: new Date('2016-05-10T23:00:00Z')}
            ],
        ...
        },
        {
            ...
            budget: 30000,
            outcomeReviews: [
                {outcomeReview: p1gw14Out1, newScore: goScore3, reviewComment: 'Outcome achieved as expected'},
                {outcomeReview: p1gw14Out2, newScore: goScore3, reviewComment: 'Outcome achieved as expected'},
                {outcomeReview: p1gw14Out3, newScore: goScore3, reviewComment: 'Outcome achieved as expected'},
                {outcomeReview: p1gw14Out4, newScore: goScore3, reviewComment: 'Outcome achieved as expected'}
            ],
        ...
        },
        {
            ...
            budget: 30000,
            outcomeReviews: [
                {outcomeReview: p1gw15Out1, newScore: goScore3, reviewComment: 'Outcome achieved as expected'},
                {outcomeReview: p1gw15Out2, newScore: goScore3, reviewComment: 'Outcome achieved as expected'},
                {outcomeReview: p1gw15Out3, newScore: goScore3, reviewComment: 'Outcome achieved as expected'},
                {outcomeReview: p1gw15Out4, newScore: goScore3, reviewComment: 'Outcome achieved as expected'}
            ],
        ...
        },
        {
            ...
            budget: 5000,
            outcomeReviews: [
                {outcomeReview: p1gw16Out1, newScore: goScore3, reviewComment: 'Outcome achieved as expected'},
                {outcomeReview: p1gw16Out2, newScore: goScore3, reviewComment: 'Outcome achieved as expected'},
                {outcomeReview: p1gw16Out3, newScore: goScore3, reviewComment: 'Outcome achieved as expected'},
                {outcomeReview: p1gw16Out4, newScore: goScore3, reviewComment: 'Outcome achieved as expected'}
            ],
