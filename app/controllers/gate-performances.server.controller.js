...
var getPortfolioPerformances = function(user, portfolio, callback){
    // user = { _id , displayName }
    // portfolio = { _id , name , budget:{currentRecord:{amount}} }
...
exports.portfolioPerformances = function(req, res){
    ...
    getPortfolioPerformances(user, portfolio, function(err, result){
        if (err) {
            console.log(err);
